...
namespace ZR.U8API.Model
{
	...
	public partial class RdRecord01
	{
		...
		/// 到货单号
		/// </summary>
		public string carvcode { get; set; } = string.Empty;
		...
		/// 币种
		/// </summary>
		public string cexch_name { get; set; } = string.Empty;
		...
		/// 流程模式描述
		/// </summary>
		public string cflowname { get; set; } = string.Empty;

		public string cgcroutecode { get; set; } = string.Empty;

		public string cgcroutename { get; set; } = string.Empty;
		...
		/// 订单号
		/// </summary>
		public string cordercode { get; set; } = string.Empty;
		...
		/// 采购类型
		/// </summary>
		public string cptname { get; set; } = string.Empty;
		...
		/// 
		/// </summary>
		public string cstcode { get; set; } = string.Empty;
		...
		/// 供应商全称
		/// </summary>
		public string cvenfullname { get; set; } = string.Empty;

		/// <summary>
		/// 收付款协议编码
		/// </summary>
		public string cvenpuomprotocol { get; set; } = string.Empty;

		/// <summary>
		/// 收付款协议名称
		/// </summary>
		public string cvenpuomprotocolname { get; set; } = string.Empty;
		...
		/// 
		/// </summary>
		public string dkeepdate { get; set; } = string.Empty;
		...
		/// gsp复核标志
		/// </summary>
		public string gspcheck { get; set; } = string.Empty;

		/// <summary>
		/// 到货单ID
		/// </summary>
		public string iarriveid { get; set; } = string.Empty;
		...
		/// 发票号
		/// </summary>
		public string isalebillid { get; set; } = string.Empty;
